...
arransubsect %>%
  ...
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004409, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004372, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004353, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004352, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004351, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004350, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01004349, aes(fill = DataZone))
```
...
arransubsect %>%
  ...
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011177, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011171, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011174, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011176, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011172, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011173, aes(fill = DataZone))

arransubsect %>%
  ggplot() +
  geom_sf() +
  theme(axis.text.x=element_text(angle=45, hjust = 1)) +
  geom_sf(data= S01011175, aes(fill = DataZone))
